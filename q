...
DDEESSCCRRIIPPTTIIOONN
       ...
       reconcile the divergent branches with ----rreebbaassee or ----nnoo--rreebbaassee (or the corresponding
       configuration option in ppuullll..rreebbaassee).

       More precisely, ggiitt ppuullll runs ggiitt ffeettcchh with the given parameters and then depending on
       configuration options or command line flags, will call either ggiitt rreebbaassee or ggiitt mmeerrggee to
       reconcile diverging branches.

       <repository> should be the name of a remote repository as passed to ggiitt--ffeettcchh(1). <refspec>
       ...
       configuration for the current branch as set by ggiitt--bbrraanncchh(1) ----ttrraacckk.
       ...
       Then "ggiitt ppuullll" will fetch and replay the changes from the remote mmaasstteerr branch since it
       diverged from the local mmaasstteerr (i.e., EE) until its current commit (CC) on top of mmaasstteerr and
       ...
       In Git 1.7.0 or later, to cancel a conflicting merge, use ggiitt rreesseett ----mmeerrggee. WWaarrnniinngg: In
       older versions of Git, running _g_i_t _p_u_l_l with uncommitted changes is discouraged: while
       ...
       changes in working order before pulling or stash them away with ggiitt--ssttaasshh(1).
...
OOPPTTIIOONNSS
       ...
       --[no-]recurse-submodules[=yes|on-demand|no]
           ...
           the working trees of active submodules should be updated, too (see ggiitt--ffeettcchh(1), ggiitt--
           ccoonnffiigg(1) and ggiittmmoodduulleess(5)).
   ...
   OOppttiioonnss rreellaatteedd ttoo mmeerrggiinngg
       ...
       --edit, -e, --no-edit
           ...
           ----nnoo--eeddiitt option can be used to accept the auto-generated message (this is generally
           discouraged).

           Older scripts may depend on the historical behaviour of not allowing the user to edit
           the merge log message. They will see an editor opened when they run ggiitt mmeerrggee. To make
       ...
       --cleanup=<mode>
           ...
           ggiitt--ccoommmmiitt(1) for more details. In addition, if the _<_m_o_d_e_> is given a value of sscciissssoorrss,
           scissors will be appended to MMEERRGGEE__MMSSGG before being passed on to the commit machinery in
       ...
       --ff, --no-ff
           ...
           history is already a descendant of the current history. If merging is requested, ----ffff is
           the default unless merging an annotated (and possibly signed) tag that is not stored in
           its natural place in the rreeffss//ttaaggss// hierarchy, in which case ----nnoo--ffff is assumed.
           ...
           With ----nnoo--ffff, create a merge commit in all cases, even when the merge could instead be
           resolved as a fast-forward.

       -S[<keyid>], --gpg-sign[=<keyid>], --no-gpg-sign
           GPG-sign the resulting merge commit. The kkeeyyiidd argument is optional and defaults to the
           committer identity; if specified, it must be stuck to the option without a space.
           ----nnoo--ggppgg--ssiiggnn is useful to countermand both ccoommmmiitt..ggppggSSiiggnn configuration variable, and
           earlier ----ggppgg--ssiiggnn.

       --log[=<n>], --no-log
           In addition to branch names, populate the log message with one-line descriptions from at
           most <n> actual commits that are being merged. See also ggiitt--ffmmtt--mmeerrggee--mmssgg(1). Only
           useful when merging.

           With --no-log do not list one-line descriptions from the actual commits being merged.

       --signoff, --no-signoff
           Add a SSiiggnneedd--ooffff--bbyy trailer by the committer at the end of the commit log message. The
           ...
           Origin. (See hhttttpp::////ddeevveellooppeerrcceerrttiiffiiccaattee..oorrgg for the one used by the Linux kernel and
           Git projects.) Consult the documentation or leadership of the project to which you’re
       ...
       --[no-]verify
           By default, the pre-merge and commit-msg hooks are run. When ----nnoo--vveerriiffyy is given, these
           are bypassed. See also ggiitthhooookkss(5). Only useful when merging.

       -s <strategy>, --strategy=<strategy>
           Use the given merge strategy; can be supplied more than once to specify them in the
           order they should be tried. If there is no --ss option, a built-in list of strategies is
           used instead (oorrtt when merging a single head, ooccttooppuuss otherwise).
       ...
       --verify-signatures, --no-verify-signatures
           ...
           has been signed by a trusted key. If the tip commit of the side branch is not signed
       ...
       --autostash, --no-autostash
           ...
           the special ref MMEERRGGEE__AAUUTTOOSSTTAASSHH and apply it after the operation ends. This means that
       ...
       -r, --rebase[=false|true|merges|interactive]
           ...
           branch was rebased since last fetched, the rebase uses that information to avoid
           rebasing non-local changes.

           When set to mmeerrggeess, rebase using ggiitt rreebbaassee ----rreebbaassee--mmeerrggeess so that the local merge
           commits are included in the rebase (see ggiitt--rreebbaassee(1) for details).

           When false, merge the upstream branch into the current branch.

           When iinntteerraaccttiivvee, enable the interactive mode of rebase.

           See ppuullll..rreebbaassee, bbrraanncchh..<<nnaammee>>..rreebbaassee and bbrraanncchh..aauuttooSSeettuuppRReebbaassee in ggiitt--ccoonnffiigg(1) if you
           want to make ggiitt ppuullll always use ----rreebbaassee instead of merging.

               NNoottee
               This is a potentially _d_a_n_g_e_r_o_u_s mode of operation. It rewrites history, which does
               not bode well when you published that history already. Do nnoott use this option unless
               you have read ggiitt--rreebbaassee(1) carefully.
   ...
   OOppttiioonnss rreellaatteedd ttoo ffeettcchhiinngg
       ...
       -a, --append
           ...
           ..ggiitt//FFEETTCCHH__HHEEAADD. Without this option old data in ..ggiitt//FFEETTCCHH__HHEEAADD will be overwritten.
       ...
       --depth=<depth>
           ...
           history. If fetching to a _s_h_a_l_l_o_w repository created by ggiitt cclloonnee with ----ddeepptthh==<<ddeepptthh>>
           option (see ggiitt--cclloonnee(1)), deepen or shorten the history to the specified number of
       ...
       --shallow-exclude=<revision>
           Deepen or shorten the history of a shallow repository to exclude commits reachable from
           a specified remote branch or tag. This option can be specified multiple times.
       ...
       --update-shallow
           By default when fetching from a shallow repository, ggiitt ffeettcchh refuses refs that require
       ...
       --negotiation-tip=<commit|glob>
           ...
           find common commits in an attempt to reduce the size of the to-be-received packfile. If
           ...
           See also the ffeettcchh..nneeggoottiiaattiioonnAAllggoorriitthhmm and ppuusshh..nneeggoottiiaattee configuration variables
           documented in ggiitt--ccoonnffiigg(1), and the ----nneeggoottiiaattee--oonnllyy option below.

       --negotiate-only
           Do not fetch anything from the server, and instead print the ancestors of the provided
           ----nneeggoottiiaattiioonn--ttiipp==** arguments, which we have in common with the server.

           This is incompatible with ----rreeccuurrssee--ssuubbmmoodduulleess==[[yyeess||oonn--ddeemmaanndd]]. Internally this is used
           to implement the ppuusshh..nneeggoottiiaattee option, see ggiitt--ccoonnffiigg(1).

       --dry-run
           Show what would be done, without making any changes.

       -f, --force
           When _g_i_t _f_e_t_c_h is used with <<ssrrcc>>::<<ddsstt>> refspec it may refuse to update the local branch
           as discussed in the <<rreeffssppeecc>> part of the ggiitt--ffeettcchh(1) documentation. This option
       ...
       --prefetch
           Modify the configured refspec to place all refs into the rreeffss//pprreeffeettcchh// namespace. See
           the pprreeffeettcchh task in ggiitt--mmaaiinntteennaannccee(1).
       ...
       -p, --prune
           ...
           pruning. Supplying ----pprruunnee--ttaaggss is a shorthand for providing the tag refspec.
       ...
       --refmap=<refspec>
           ...
           rreemmoottee..**..ffeettcchh configuration variables for the remote repository. Providing an empty
           <<rreeffssppeecc>> to the ----rreeffmmaapp option causes Git to ignore the configured refspecs and rely
       ...
       -t, --tags
           Fetch all tags from the remote (i.e., fetch remote tags rreeffss//ttaaggss//** into local tags with
           ...
           be pruned anyway if they are also the destination of an explicit refspec; see ----pprruunnee).

       -j, --jobs=<n>
           Number of parallel children to be used for all forms of fetching.

           If the ----mmuullttiippllee option was specified, the different remotes will be fetched in
           parallel. If multiple submodules are fetched, they will be fetched in parallel. To
           control them independently, use the config settings ffeettcchh..ppaarraalllleell and
           ssuubbmmoodduullee..ffeettcchhJJoobbss (see ggiitt--ccoonnffiigg(1)).
       ...
       --set-upstream
           ...
           argument-less ggiitt--ppuullll(1) and other commands. For more information, see
           bbrraanncchh..<<nnaammee>>..mmeerrggee and bbrraanncchh..<<nnaammee>>..rreemmoottee in ggiitt--ccoonnffiigg(1).

       --upload-pack <upload-pack>
           When given, and the repository to fetch from is handled by _g_i_t _f_e_t_c_h_-_p_a_c_k,
           ----eexxeecc==<<uuppllooaadd--ppaacckk>> is passed to the command to specify non-default path for the
       ...
       -o <option>, --server-option=<option>
           ...
           ----sseerrvveerr--ooppttiioonn==<<ooppttiioonn>> are given, they are all sent to the other side in the order
       ...
       --show-forced-updates
           ...
           check occurs. See ggiitt--ccoonnffiigg(1).
       ...
       --no-show-forced-updates
           ...
           performance reasons. If used during _g_i_t_-_p_u_l_l the --ff-only option will still check for
           forced updates before attempting a fast-forward update. See ggiitt--ccoonnffiigg(1).
       ...
       <refspec>
           ...
           on the command line, the refs to fetch are read from rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh variables
           instead (see the section "CONFIGURED REMOTE-TRACKING BRANCHES" in ggiitt--ffeettcchh(1)).
           ...
           specifying which refs to fetch or which local refs to update, such a refspec will
           ...
           only contain a <src> and do not specify a <dst>. Fully spelled out hex object names are
           also not supported.

           ttaagg <<ttaagg>> means the same as rreeffss//ttaaggss//<<ttaagg>>::rreeffss//ttaaggss//<<ttaagg>>; it requests fetching
           ...
           Whether that update is allowed without ----ffoorrccee depends on the ref namespace it’s being
           ...
           <<rreeffssppeecc>>......  section of ggiitt--ppuusshh(1) for what those are. Exceptions to those rules
           particular to _g_i_t _f_e_t_c_h are noted below.

           Until Git version 2.20, and unlike when pushing with ggiitt--ppuusshh(1), any updates to
           rreeffss//ttaaggss//** would be accepted without ++ in the refspec (or ----ffoorrccee). When fetching, we
           promiscuously considered all tag updates from a remote to be forced fetches. Since Git
           version 2.20, fetching to update rreeffss//ttaaggss//** works the same way as when pushing. I.e.
           any updates will be rejected without ++ in the refspec (or ----ffoorrccee).

           Unlike when pushing with ggiitt--ppuusshh(1), any updates outside of rreeffss//{{ttaaggss,,hheeaaddss}}//** will be
           accepted without ++ in the refspec (or ----ffoorrccee), whether that’s swapping e.g. a tree
           object for a blob, or a commit for another commit that’s doesn’t have the previous
           commit as an ancestor etc.

           Unlike when pushing with ggiitt--ppuusshh(1), there is no configuration which’ll amend these
           rules, and nothing like a pprree--ffeettcchh hook analogous to the pprree--rreecceeiivvee hook.

           As with pushing with ggiitt--ppuusshh(1), all of the rules described above about what’s not
           allowed as an update can be overridden by adding an the optional leading ++ to a refspec
           (or using ----ffoorrccee command line option). The only exception to this is that no amount of
           forcing will make the rreeffss//hheeaaddss//** namespace accept a non-commit object.
               ...
               tip (as stored in your remote-tracking branch the last time you fetched). You would
               want to use the ++ sign to indicate non-fast-forward updates will be needed for such
               ...
               NNoottee
               There is a difference between listing multiple <refspec> directly on _g_i_t _p_u_l_l
               command line and having multiple rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh entries in your
               configuration for a <repository> and running a _g_i_t _p_u_l_l command without any explicit
               <refspec> parameters. <refspec>s listed explicitly on the command line are always
               merged into the current branch after fetching. In other words, if you list more than
               one remote ref, _g_i_t _p_u_l_l will create an Octopus merge. On the other hand, if you do
               not list any explicit <refspec> parameter on the command line, _g_i_t _p_u_l_l will fetch
               all the <refspec>s it finds in the rreemmoottee..<<rreeppoossiittoorryy>>..ffeettcchh configuration and merge
               only the first <refspec> found into the current branch. This is because making an
               Octopus from remote refs is rarely done, while keeping track of multiple remote
...
GGIITT UURRLLSS
       ...
       _g_i_t _c_l_o_n_e, _g_i_t _f_e_t_c_h and _g_i_t _p_u_l_l, but not _g_i_t _p_u_s_h, will also accept a suitable bundle
...
MMEERRGGEE SSTTRRAATTEEGGIIEESS
       The merge mechanism (ggiitt mmeerrggee and ggiitt ppuullll commands) allows the backend _m_e_r_g_e _s_t_r_a_t_e_g_i_e_s to
       be chosen with --ss option. Some strategies can also take their own options, which can be
       passed by giving --XX<<ooppttiioonn>> arguments to ggiitt mmeerrggee and/or ggiitt ppuullll.
       ...
       ort
           ...
           ancestors and uses that as the reference tree for the 3-way merge. This has been
           ...
           strategy can detect and handle merges involving renames. It does not make use of
           detected copies. The name for this algorithm is an acronym ("Ostensibly Recursive’s
           Twin") and came from the fact that it was written as a replacement for the previous
           default algorithm, rreeccuurrssiivvee.
           ...
           ours
               ...
               reflected in the merge result. For a binary file, the entire contents are taken from
               our side.

               This should not be confused with the _o_u_r_s merge strategy, which does not even look
               at what the other tree contains at all. It discards everything the other tree did,
               declaring _o_u_r history contains all that happened in it.
           ...
           ignore-space-change, ignore-all-space, ignore-space-at-eol, ignore-cr-at-eol
               ...
               ignored. See also ggiitt--ddiiffff(1) --bb, --ww, ----iiggnnoorree--ssppaaccee--aatt--eeooll, and ----iiggnnoorree--ccrr--aatt--eeooll.

               •   If _t_h_e_i_r version only introduces whitespace changes to a line, _o_u_r version is
                   used;
           ...
           renormalize
               ...
               branches with differing checkin/checkout attributes" in ggiittaattttrriibbuutteess(5) for
               details.

           no-renormalize
               Disables the rreennoorrmmaalliizzee option. This overrides the mmeerrggee..rreennoorrmmaalliizzee configuration
               variable.

           find-renames[=<n>]
               Turn on rename detection, optionally setting the similarity threshold. This is the
               default. This overrides the _m_e_r_g_e_._r_e_n_a_m_e_s configuration variable. See also ggiitt--
               ddiiffff(1) ----ffiinndd--rreennaammeess.

           rename-threshold=<n>
               Deprecated synonym for ffiinndd--rreennaammeess==<<nn>>.

           subtree[=<path>]
               This option is a more advanced form of _s_u_b_t_r_e_e strategy, where the strategy makes a
       ...
       recursive
           ...
           additional options that _o_r_t ignores (not documented above) that are potentially useful
           with the _r_e_c_u_r_s_i_v_e strategy:
           ...
           diff-algorithm=[patience|minimal|histogram|myers]
               ...
               See also ggiitt--ddiiffff(1) ----ddiiffff--aallggoorriitthhmm. Note that oorrtt specifically uses
               ddiiffff--aallggoorriitthhmm==hhiissttooggrraamm, while rreeccuurrssiivvee defaults to the ddiiffff..aallggoorriitthhmm config
               setting.

           no-renames
               Turn off rename detection. This overrides the mmeerrggee..rreennaammeess configuration variable.
               See also ggiitt--ddiiffff(1) ----nnoo--rreennaammeess.
       ...
       octopus
           ...
           heads together. This is the default merge strategy when pulling or merging more than one
           branch.
       ...
       ours
           ...
           meant to be used to supersede old development history of side branches. Note that this
           is different from the -Xours option to the _r_e_c_u_r_s_i_v_e merge strategy.
       ...
       With the strategies that use 3-way merge (including the default, _o_r_t), if a change is made
       on both branches, but later reverted on one of the branches, that change will be present in
       the merged result; some people find this behavior confusing. It occurs because only the
...
DDEEFFAAUULLTT BBEEHHAAVVIIOOUURR
       Often people use ggiitt ppuullll without giving any parameter. Traditionally, this has been
       equivalent to saying ggiitt ppuullll oorriiggiinn. However, when configuration bbrraanncchh..<<nnaammee>>..rreemmoottee is
       present while on branch <<nnaammee>>, that value is used instead of oorriiggiinn.

       In order to determine what URL to use to fetch from, the value of the configuration
       rreemmoottee..<<oorriiggiinn>>..uurrll is consulted and if there is not any such variable, the value on the
       UURRLL:: line in $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>> is used.
       ...
       command line, values of the configuration variable rreemmoottee..<<oorriiggiinn>>..ffeettcchh are consulted, and
       if there aren’t any, $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>> is consulted and its PPuullll:: lines are used. In
       ...
       all remote branches are tracked using remote-tracking branches in rreeffss//rreemmootteess//oorriiggiinn//
       ...
       When no refspec was given on the command line, then ggiitt ppuullll uses the refspec from the
       configuration or $$GGIITT__DDIIRR//rreemmootteess//<<oorriiggiinn>>. In such cases, the following rules apply:

        1. If bbrraanncchh..<<nnaammee>>..mmeerrggee configuration for the current branch <<nnaammee>> exists, that is the
...
EEXXAAMMPPLLEESS
       •   Update the remote-tracking branches for the repository you cloned from, then merge one
           ...
           determined by the branch.<name>.remote and branch.<name>.merge options; see ggiitt--
           ccoonnffiigg(1) for details.

       •   Merge into the current branch the remote branch nneexxtt:

               $ git pull origin next

           This leaves a copy of nneexxtt temporarily in FETCH_HEAD, and updates the remote-tracking
           branch oorriiggiinn//nneexxtt. The same can be done by invoking fetch and merge:

               $ git fetch origin
               $ git merge origin/next

       If you tried a pull which resulted in complex conflicts and would want to start over, you
       can recover with _g_i_t _r_e_s_e_t.
...
BBUUGGSS
       ...
       superproject the submodule itself cannot be fetched, making it impossible to check out that
       submodule later without having to do a fetch again. This is expected to be fixed in a future
       Git version.
...
Git 2.39.0                                   12/12/2022                                 GIT-PULL(1)
